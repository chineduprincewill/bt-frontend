...
import NotificationsIcon from '../../assets/.png';
...
export default function SettingsMobile() {
    ...
    useEffect(() => {
        ...
        if (window.innerWidth >= 768 && !location.pathname.startsWith('/settings-new')) {
    ...
    return (
        <div className={`absolute w-screen   min-h-screen h-full space-y-5  pt-32 md:pt-12 px-12 ${isMenuVisible ? '' : 'hidden'}`}>
